...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.setupVersion = exports.getVersionFromCommitSha = exports.getVersionFromTag = void 0;
...
const moment_1 = __importDefault(__nccwpck_require__(623));
function getVersionFromTag(ref) {
    if (!ref || ref.trim().length === 0) {
        return undefined;
    }
    const regex = new RegExp('^refs\\/tags\\/(v\\d+\\.\\d+\\.\\d+(-(rc|hotfix)\\d+)?)$', 'gm');
...
function getVersionFromCommitSha(sha) {
